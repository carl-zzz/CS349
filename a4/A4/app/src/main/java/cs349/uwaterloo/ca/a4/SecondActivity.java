...
public class SecondActivity extends AppCompatActivity
{
    ...
    public void startGame() {
        secondViewModel.setState(1);
        while (secondViewModel.getState() == 1) {
            int tmp = secondViewModel.nextButton();
            if (tmp == 0) {
                button1.setBackgroundColor(Color.BLUE);
                secondViewModel.draw();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        button1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                // Update view model
                int i = secondViewModel.getState();
                if (i == 2) {
                    boolean correct = secondViewModel.verifyButton(0);
                } else if (i == 0 || i == 3 || i == 4){
                    startGame();
                }
            }
        ...
        button2.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                int i = secondViewModel.getState();
                if (i == 2) {
                    boolean correct = secondViewModel.verifyButton(1);
                } else if (i == 0 || i == 3 || i == 4){
                    startGame();
                }
            }
        ...
        button3.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                int i = secondViewModel.getState();
                if (i == 2) {
                    boolean correct = secondViewModel.verifyButton(2);
                } else if (i == 0 || i == 3 || i == 4){
                    startGame();
                }
            }
        ...
        button4.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                int i = secondViewModel.getState();
                if (i == 2) {
                    boolean correct = secondViewModel.verifyButton(3);
                } else if (i == 0 || i == 3 || i == 4){
                    startGame();
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId())
        {
            case R.id.menu2_GoToView1:
                ...
                // Start activity
                this.secondViewModel.setState(0);
